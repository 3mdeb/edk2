...
static void mem_region_device_init(struct mem_region_device *mdev,
		const struct region_device_ops *ops, void *base, __SIZE_TYPE__ size)
{
...
static void *mdev_mmap(const struct region_device *rd, __SIZE_TYPE__ offset,
			__SIZE_TYPE__ size __unused)
{
...
static __SIZE_TYPE__ mdev_readat(const struct region_device *rd, void *b,
				__SIZE_TYPE__ offset, __SIZE_TYPE__ size)
{
	const struct mem_region_device *mdev;
...
static __SIZE_TYPE__ mdev_writeat(const struct region_device *rd, const void *b,
				__SIZE_TYPE__ offset, __SIZE_TYPE__ size)
{
	const struct mem_region_device *mdev;
...
static __SIZE_TYPE__ mdev_eraseat(const struct region_device *rd, __SIZE_TYPE__ offset,
				__SIZE_TYPE__ size)
{
	const struct mem_region_device *mdev;
...
static void *xlate_mmap(const struct region_device *rd, __SIZE_TYPE__ offset,
			__SIZE_TYPE__ size)
{
...
static __SIZE_TYPE__ xlate_readat(const struct region_device *rd, void *b,
				__SIZE_TYPE__ offset, __SIZE_TYPE__ size)
{
	struct region req = {
		.offset = offset,
...
static __SIZE_TYPE__ xlate_writeat(const struct region_device *rd, const void *b,
				__SIZE_TYPE__ offset, __SIZE_TYPE__ size)
{
	struct region req = {
		.offset = offset,
...
static __SIZE_TYPE__ xlate_eraseat(const struct region_device *rd,
				__SIZE_TYPE__ offset, __SIZE_TYPE__ size)
{
	struct region req = {
		.offset = offset,
...
static void *incoherent_mmap(const struct region_device *rd, __SIZE_TYPE__ offset,
				__SIZE_TYPE__ size)
{
...
static __SIZE_TYPE__ incoherent_readat(const struct region_device *rd, void *b,
				__SIZE_TYPE__ offset, __SIZE_TYPE__ size)
{
	const struct incoherent_rdev *irdev;
...
static __SIZE_TYPE__ incoherent_writeat(const struct region_device *rd, const void *b,
			__SIZE_TYPE__ offset, __SIZE_TYPE__ size)
{
	const struct incoherent_rdev *irdev;
...
static __SIZE_TYPE__ incoherent_eraseat(const struct region_device *rd, __SIZE_TYPE__ offset,
				__SIZE_TYPE__ size)
{
	const struct incoherent_rdev *irdev;
...
{
	const __SIZE_TYPE__ size = region_sz(r);
