...
struct spi_flash_ops {
	int (*read)(const struct spi_flash *flash, UINT32 offset, __SIZE_TYPE_ len,
			void *buf);
	int (*write)(const struct spi_flash *flash, UINT32 offset, __SIZE_TYPE_ len,
			const void *buf);
	int (*erase)(const struct spi_flash *flash, UINT32 offset, __SIZE_TYPE_ len);
...
int spi_flash_read(const struct spi_flash *flash, UINT32 offset, __SIZE_TYPE_ len,
		   void *buf);
int spi_flash_write(const struct spi_flash *flash, UINT32 offset, __SIZE_TYPE_ len,
		    const void *buf);
int spi_flash_erase(const struct spi_flash *flash, UINT32 offset, __SIZE_TYPE_ len);
...
int spi_flash_vector_helper(const struct spi_slave *slave,
	struct spi_op vectors[], __SIZE_TYPE_ count,
	int (*func)(const struct spi_slave *slave, const void *dout,
		    __SIZE_TYPE_ bytesout, void *din, __SIZE_TYPE_ bytesin));
